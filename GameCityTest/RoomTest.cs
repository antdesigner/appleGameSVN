...
namespace GameCityTest
{
    ...
    public class RoomTest
    {
        ...
        [Fact(DisplayName = "玩家进入余额不足触发事件_房主")]
        ...
        [Fact(DisplayName = "玩家进入余额不足触发事件_非房主")]
